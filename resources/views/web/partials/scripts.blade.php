...
<script src="{{ asset('js/web/greensock/TweenMax.min.js') }}"></script>
<script src="{{ asset('js/web/greensock/TimelineMax.min.js') }}"></script>
<script src="{{ asset('js/web/scrollmagic/ScrollMagic.min.js') }}"></script>
